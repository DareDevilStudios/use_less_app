        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="max-w-screen-md mb-8 lg:mb-16">
                    ...
                    <p class="text-gray-500 sm:text-xl dark:text-gray-400">We provide features like</p>
                </div>
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Daily Reality Checks</h3>
                        <p class="text-gray-500 dark:text-gray-400">Get a blunt assessment of your productivity each day - because sugarcoating won't get you results.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">To-Do List Accountability</h3>
                        <p class="text-gray-500 dark:text-gray-400">No tasks? Expect a stern talking-to. Add tasks, and we'll make sure you complete them with reminders that keep you in check.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Productivity Reports, Father-Style</h3>
                        <p class="text-gray-500 dark:text-gray-400">Weekly reports that don’t hold back. Celebrate your wins and confront your laziness - all in a no-nonsense tone.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Brutally Honest Reminders</h3>
                        <p class="text-gray-500 dark:text-gray-400">Forget the gentle nudges. Our reminders are designed to keep you on task and make procrastination feel like a bad idea.</p>
                    </div>
                    <div>
                        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 class="mb-2 text-xl font-bold dark:text-white">Progress Tracker - Because We're Watching</h3>
                        <p class="text-gray-500 dark:text-gray-400">Track your accomplishments with stats and unlock badges that reflect your productivity growth (or lack thereof).</p>
                    </div>
                </div>
            </div>
        </section>
